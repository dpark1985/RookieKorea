...
.controller('RegisterCtrl', ['$rootScope', '$scope', '$http', '$timeout', '$location', function($rootScope, $scope, $http, $timeout, $location) {
...
.controller('NewInfoCtrl', ['$scope', '$location', '$rootScope', '$http', '$window', function($scope, $location, $rootScope, $http, $window) {
...
.controller('LoginCtrl', ['$scope', '$location', '$rootScope', '$http', '$timeout', function($scope, $location, $rootScope, $http, $timeout) {
    ...
    $scope.doLogin = function() {
        ...
        // http.post requests user information to the server
        // server url "http://52.69.2.200/happ/testing"
        $http.post('http://52.69.2.200/happ/testing', {
          status: "login",
        ...
        .success(function(data, status, headers, config) {
          if(data){
            ...
            $rootScope.userInfo = data; // insert the login data to $rootScope.userInfo
            //console.log(data);
            ...
            $rootScope.isLogin = false; // login failed, Login Status : false
